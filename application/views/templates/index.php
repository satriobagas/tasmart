							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<h2>Lampu1 <div class="selectgroup selectgroup-secondary selectgroup-pills">
												<label class="selectgroup-item">
													<input type="checkbox" id="indikator1" name="indikator1" disabled="disabled" class="selectgroup-input">
													<span class="selectgroup-button selectgroup-button-icon"><i class="flaticon-idea"></i></span>
												</label>
											</div>
										</h2>
									</div>
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-2">
										<ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center" id="lampu1" role="tablist">
											<li class="nav-item">
												<a class="nav-link" id="lamp1on" name="lamp1on" data-toggle="pill" role="tab" aria-controls="pills-home-icon">
													<i class="flaticon-idea"></i>
													Lamp On
												</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" id="lamp1off" name="lamp1off" data-toggle="pill" role="tab" aria-controls="pills-profile-icon">
								...
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-2">
										<ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center" id="pills-tab-with-icon" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" id="lamp2off" name="lamp2off" data-toggle="pill" role="tab" aria-controls="pills-profile-icon" aria-selected="false">
													<i class="flaticon-power"></i>
													Lamp Off
												</a>
											</li>
