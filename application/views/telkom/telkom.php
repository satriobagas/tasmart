    ...
    <div class="content">
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="row">
                    <div class="col-md-6 d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        <div>
                            <h2 class="text-white pb-2 fw-bold">Laboratorium Telkom</h2>
                            <h5 class="text-white op-7 mb-2"><b>IoT</b> Smart Classroom Dashboard</h5>
                        </div>
                    </div>
                    <div class="col-md-auto mid ml-md-auto align-items-center">
                        <h2 class="text-white mt-3 mr-3 op-7">Otomatis</h2>
                        <label class="rocker ml-md-auto align-items-center">
                            <input type="checkbox" id="auto">
                            <span class="switch-left" id="autoOn">On</span>
                            <span class="switch-right" id="autoOff">Off</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt--2">
                <div class="col-md-4 ml-auto mr-auto">
                    <div class="card card-stats card-round">
                        <div class="card-body" style="margin-top: 30px; margin-bottom:35px">
                            <div class="row">
                                <div class="col-5">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        <p class="card-category" style="font-size:15px">Suhu</p>
                                        <h4 class="card-title" style="font-size: 27px"><b id="suhu"></b>&deg; C</h4>
                        ...
                        <div class="price-value">
                            <div class="value">
                                ...
                                <span class="amount">
                                    <div class="selectgroup selectgroup-secondary selectgroup-pills ml-1 mt-2">
                                        <label class="selectgroup-item">
                                            <input type="checkbox" id="occupancy" disabled="disabled" class="selectgroup-input">
